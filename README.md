...
- # Basic information  
	- This guide describes security-enhanced Arch GNU/Linux installation, which can be useful for [Cybersecurity Engineers](Cybersecurity Engineer), [Cybersecurity Analysts](Cybersecurity Analyst), [Pentesters](Pentester).  
- # Basic requirements  
	- [reEFInd bootloader](rEFInd) with [minimalistic theme](https://github.com/evanpurkhiser/rEFInd-minimal)  
	- Hardened Linux Kernel  
	- AppArmor  
	- BTRFS  
	- [AES encryption](AES) of Root Filesystem  
	- ZRAM  
	- Wayland  
	- XWayland  
	- Sway WM  
...
- # Installation  
	...
	- ## Step 2 $\implies$ Check integrity and digital signature of image  
		- For this, use sha256sum command and [gpg](GPG)  
